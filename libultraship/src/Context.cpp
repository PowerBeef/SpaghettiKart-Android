...
std::string Context::GetAppBundlePath() {
    ...
    jclass cls = env->FindClass("com/izzy/kart/MainActivity");
    jmethodID mid = env->GetStaticMethodID(cls, "getSaveDir", "()Ljava/lang/String;");
...
#if defined(__ANDROID__)
    // Always use the same as AppBundlePath for Android
